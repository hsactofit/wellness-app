...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      await tester.tap(find.byTooltip('Edit comparison'));
      await tester.pumpAndSettle();
      expect(find.text('Edit comparison reports'), findsOneWidget);
      expect(find.text('Earlier report'), findsOneWidget);
      expect(find.text('Latest report'), findsOneWidget);
      expect(find.byType(DropdownButtonFormField<String>), findsNothing);
      await tester.tap(find.text('Earlier report'));
      await tester.pumpAndSettle();
      expect(find.text('Edit health report'), findsOneWidget);
      expect(find.text('Save changes'), findsOneWidget);
      expect(find.byType(TextField), findsWidgets);
      expect(find.text('Edit comparison reports'), findsNothing);
